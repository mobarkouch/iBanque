package org.Barkouch.iBanque;

import org.Barkouch.iBanque.dtos.BankAccountDTO;
import org.Barkouch.iBanque.dtos.CurrentBankAccountDTO;
import org.Barkouch.iBanque.dtos.CustomerDTO;
import org.Barkouch.iBanque.dtos.SavingBankAccountDTO;
...
public class IbanqueApp {

    public static void main(String[] args) {
        SpringApplication.run(IbanqueApp.class, args);
    }

    @Bean
    CommandLineRunner commandLineRunner(BankAccountService bankAccountService){
        return args -> {
            Stream.of("Ayoub","Ali","Mohamed").forEach(name->{
